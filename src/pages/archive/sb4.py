...
base_path = "/archive/sb4"
physical_path = "public/archive/sb4"
...
def sb4():
  ...
  Body(
    ...
    Span('Sketchbook 4', cls='font-times block mt-24 mb-8 text-3xl center-text flex items-center justify-center '),
    Div(
      Div(
