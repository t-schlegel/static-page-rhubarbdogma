...
base_path = "/archive/sb1"
physical_path = "public/archive/sb1"
...
def sb1():
  ...
  Body(
    ...
    Span('Sketchbook 1', cls='font-times block mt-24 mb-8 text-3xl center-text flex items-center justify-center '),
    Div(
      Div(
