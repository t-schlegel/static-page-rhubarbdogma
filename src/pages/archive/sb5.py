...
base_path = "/archive/sb5"
physical_path = "public/archive/sb5"
...
def sb5():
  ...
  Body(
    ...
    Span('Sketchbook 5', cls='font-times block mt-24 mb-8 text-3xl center-text flex items-center justify-center '),
    Div(
      Div(
        *generate_sketches(base_path, physical_path, limit=24),
