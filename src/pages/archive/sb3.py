...
base_path = "/archive/sb3"
physical_path = "public/archive/sb3"
...
def sb3():
  ...
  Body(
    ...
    Span('Sketchbook 3', cls='font-times block mt-24 mb-8 text-3xl center-text flex items-center justify-center '),
    Div(
      Div(
